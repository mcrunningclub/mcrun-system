...
A simple spreadsheet + Google Apps Script project to check the membership status of everyone who signed up to McRace with the McRun member discount. 

### Permissions

Requires read access to the McRace registrations (Fillout) spreadsheet and the Memberships Collected (main) spreadsheet.
